...
cd "$PROJECT_ROOT/backend" && $POETRY_BIN run python -c "from pydantic2ts import generate_typescript_defs; generate_typescript_defs('{{PYTHON_PACKAGE_NAME}}.models', '../frontend/src/types/apiTypes.ts')"
